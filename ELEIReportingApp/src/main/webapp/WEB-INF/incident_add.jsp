							...
							<div class="card">
								...
								<div class="card-body">
									...
									<form action="createIncident.do" method="post">
										...
										<input type="button" onclick="clickNewPersonButton()" id="newPersonButton" value="Create New Person" />
										<input type="button" onclick="clickPersonTableButton()" id="choosePersonFromList" value="Select Person From List" />
										<!-- <input type="button" onclick="clickNewAddressButton()" id="newAddressButton" value="Create New Address" /> -->
										<input type="button" onclick="clickAddressTableButton()" id="chooseAddressFromList" value="Select Address From List" />
										
										<input type="hidden" id="addressId" name="addressId">
										<input type="hidden" id="personIdHidden" name="personId">
										
										<div id="incident-person-form">
											<input class="btn btn-primary" type="button" id="selectedPerson">
